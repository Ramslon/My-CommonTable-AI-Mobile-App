...
class CommunityRecommendationService {
  ...
  Future<List<CommunityPost>> recommendForUser(String? userId, List<CommunityPost> recent) async {
    // Simple heuristic: prioritize posts with higher engagement
    final sorted = [...recent]..sort((a, b) => (b.likesCount + b.commentsCount).compareTo(a.likesCount + a.commentsCount));
